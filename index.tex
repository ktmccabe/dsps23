...
01:790:391:01: Data Science for Political Science for the fall 2023
semester.
...
\item
  ...
  portions of the code in different sections. These will be located in
  the playlist linked
  \href{https://youtube.com/playlist?list=PLx0unV_UpWcVWiQgq55YZxemiH7KrtPU-}{here}.
\end{itemize}

In addition, the chat bot below can be used to ask questions about
material included on lecture slides posted on Canvas as well as the pdf
version of this website, which can be accessed using the pdf icon in the
top-left sidebar of this page.
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{class}\NormalTok{(speeches}\SpecialCharTok{$}\NormalTok{sotu\_text)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\DocumentationTok{\#\# Example of speech}
\NormalTok{speeches}\SpecialCharTok{$}\NormalTok{sotu\_text[}\DecValTok{1}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\DocumentationTok{\#\# clean text}
\NormalTok{speeches}\SpecialCharTok{$}\NormalTok{sotu\_text }\OtherTok{\textless{}{-}} \FunctionTok{tolower}\NormalTok{(speeches}\SpecialCharTok{$}\NormalTok{sotu\_text)}
\NormalTok{speeches}\SpecialCharTok{$}\NormalTok{sotu\_text }\OtherTok{\textless{}{-}} \FunctionTok{stripWhitespace}\NormalTok{(speeches}\SpecialCharTok{$}\NormalTok{sotu\_text)}
\NormalTok{speeches}\SpecialCharTok{$}\NormalTok{sotu\_text }\OtherTok{\textless{}{-}} \FunctionTok{removeWords}\NormalTok{(speeches}\SpecialCharTok{$}\NormalTok{sotu\_text, }\FunctionTok{stopwords}\NormalTok{(}\AttributeTok{kind=}\StringTok{"en"}\NormalTok{))}
\NormalTok{speeches}\SpecialCharTok{$}\NormalTok{sotu\_text }\OtherTok{\textless{}{-}} \FunctionTok{removePunctuation}\NormalTok{(speeches}\SpecialCharTok{$}\NormalTok{sotu\_text)}
\NormalTok{speeches}\SpecialCharTok{$}\NormalTok{sotu\_text }\OtherTok{\textless{}{-}} \FunctionTok{removeNumbers}\NormalTok{(speeches}\SpecialCharTok{$}\NormalTok{sotu\_text)}
\CommentTok{\#speeches$sotu\_text \textless{}{-} stemDocument(speeches$sotu\_text) \# we will hold off}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\DocumentationTok{\#\# turn text into corpus}
\NormalTok{sotu.corpus }\OtherTok{\textless{}{-}} \FunctionTok{VCorpus}\NormalTok{(}\FunctionTok{VectorSource}\NormalTok{(speeches}\SpecialCharTok{$}\NormalTok{sotu\_text))}

\DocumentationTok{\#\# Add meta data into corpus}
\FunctionTok{meta}\NormalTok{(sotu.corpus, }\AttributeTok{tag=} \FunctionTok{names}\NormalTok{(sotu\_meta), }\AttributeTok{type=}\StringTok{"indexed"}\NormalTok{) }\OtherTok{\textless{}{-}}\NormalTok{ sotu\_meta}
\FunctionTok{meta}\NormalTok{(sotu.corpus)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{speeches}\SpecialCharTok{$}\NormalTok{speechlength }\OtherTok{\textless{}{-}} \FunctionTok{nchar}\NormalTok{(speeches}\SpecialCharTok{$}\NormalTok{sotu\_text)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{(}\AttributeTok{x=}\DecValTok{1}\SpecialCharTok{:}\FunctionTok{length}\NormalTok{(speeches}\SpecialCharTok{$}\NormalTok{speechlength), }\AttributeTok{y=}\NormalTok{ speeches}\SpecialCharTok{$}\NormalTok{speechlength, }
    \AttributeTok{pch=}\DecValTok{15}\NormalTok{,}
     \AttributeTok{xaxt=}\StringTok{"n"}\NormalTok{,}
     \AttributeTok{xlab=}\StringTok{""}\NormalTok{, }
     \AttributeTok{ylab =} \StringTok{"Number of Characters"}\NormalTok{)}

\DocumentationTok{\#\# add x axis}
\FunctionTok{axis}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{1}\SpecialCharTok{:}\FunctionTok{length}\NormalTok{(speeches}\SpecialCharTok{$}\NormalTok{speechlength), }\AttributeTok{labels=}\NormalTok{speeches}\SpecialCharTok{$}\NormalTok{year, }\AttributeTok{las=}\DecValTok{3}\NormalTok{, }\AttributeTok{cex.axis=}\NormalTok{.}\DecValTok{7}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{figure}[H]

{\centering \includegraphics{11-TextasData_files/figure-pdf/unnamed-chunk-17-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{speechcolor }\OtherTok{\textless{}{-}} \FunctionTok{ifelse}\NormalTok{(speeches}\SpecialCharTok{$}\NormalTok{sotu\_type }\SpecialCharTok{==} \StringTok{"written"}\NormalTok{, }\StringTok{"black"}\NormalTok{, }\StringTok{"green3"}\NormalTok{)}
\FunctionTok{plot}\NormalTok{(}\AttributeTok{x=}\DecValTok{1}\SpecialCharTok{:}\FunctionTok{length}\NormalTok{(speeches}\SpecialCharTok{$}\NormalTok{speechlength), }\AttributeTok{y=}\NormalTok{ speeches}\SpecialCharTok{$}\NormalTok{speechlength, }
     \AttributeTok{xaxt=}\StringTok{"n"}\NormalTok{, }\AttributeTok{pch=}\DecValTok{15}\NormalTok{,}
     \AttributeTok{xlab=}\StringTok{""}\NormalTok{, }
     \AttributeTok{ylab =} \StringTok{"Number of Characters"}\NormalTok{,}
     \AttributeTok{col =}\NormalTok{ speechcolor)}

\DocumentationTok{\#\# add x axis}
\FunctionTok{axis}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{1}\SpecialCharTok{:}\FunctionTok{length}\NormalTok{(speeches}\SpecialCharTok{$}\NormalTok{speechlength), }\AttributeTok{labels=}\NormalTok{speeches}\SpecialCharTok{$}\NormalTok{year, }\AttributeTok{las=}\DecValTok{3}\NormalTok{, }\AttributeTok{cex.axis=}\NormalTok{.}\DecValTok{7}\NormalTok{)}

\DocumentationTok{\#\# add legend}
\FunctionTok{legend}\NormalTok{(}\StringTok{"topleft"}\NormalTok{, }\FunctionTok{c}\NormalTok{(}\StringTok{"spoken"}\NormalTok{, }\StringTok{"written"}\NormalTok{), }
       \AttributeTok{pch=}\DecValTok{15}\NormalTok{, }
       \AttributeTok{col=}\FunctionTok{c}\NormalTok{(}\StringTok{"green3"}\NormalTok{, }\StringTok{"black"}\NormalTok{), }\AttributeTok{bty=}\StringTok{"n"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{figure}[H]

{\centering \includegraphics{11-TextasData_files/figure-pdf/unnamed-chunk-18-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{speeches}\SpecialCharTok{$}\NormalTok{terrorism }\OtherTok{\textless{}{-}} \FunctionTok{ifelse}\NormalTok{(}\FunctionTok{grepl}\NormalTok{(}\StringTok{"terror"}\NormalTok{, speeches}\SpecialCharTok{$}\NormalTok{sotu\_text), }\DecValTok{1}\NormalTok{,}\DecValTok{0}\NormalTok{)}
\NormalTok{speeches}\SpecialCharTok{$}\NormalTok{terrorism2 }\OtherTok{\textless{}{-}} \FunctionTok{ifelse}\NormalTok{(}\FunctionTok{str\_detect}\NormalTok{(speeches}\SpecialCharTok{$}\NormalTok{sotu\_text,}\StringTok{"terror"}\NormalTok{), }\DecValTok{1}\NormalTok{,}\DecValTok{0}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{sort}\NormalTok{(}\FunctionTok{tapply}\NormalTok{(speeches}\SpecialCharTok{$}\NormalTok{terrorism, speeches}\SpecialCharTok{$}\NormalTok{president, sum), }
     \AttributeTok{decreasing=}\NormalTok{T)[}\DecValTok{1}\SpecialCharTok{:}\DecValTok{10}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{speeches}\SpecialCharTok{$}\NormalTok{terrorismcount }\OtherTok{\textless{}{-}} \FunctionTok{str\_count}\NormalTok{(speeches}\SpecialCharTok{$}\NormalTok{sotu\_text, }\StringTok{"terror"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{sort}\NormalTok{(}\FunctionTok{tapply}\NormalTok{(speeches}\SpecialCharTok{$}\NormalTok{terrorismcount, speeches}\SpecialCharTok{$}\NormalTok{president, sum), }
     \AttributeTok{decreasing=}\NormalTok{T)[}\DecValTok{1}\SpecialCharTok{:}\DecValTok{10}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{speeches}\SpecialCharTok{$}\NormalTok{warcount }\OtherTok{\textless{}{-}} \FunctionTok{str\_count}\NormalTok{(speeches}\SpecialCharTok{$}\NormalTok{sotu\_text, }
                               \StringTok{"terror|war|military|drone"}\NormalTok{)}
\FunctionTok{sort}\NormalTok{(}\FunctionTok{tapply}\NormalTok{(speeches}\SpecialCharTok{$}\NormalTok{warcount, speeches}\SpecialCharTok{$}\NormalTok{president, sum), }\AttributeTok{decreasing=}\NormalTok{T)[}\DecValTok{1}\SpecialCharTok{:}\DecValTok{10}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{vivek }\OtherTok{\textless{}{-}} \FunctionTok{subset}\NormalTok{(candidates, }\AttributeTok{playlist\_name =} \StringTok{"Vivek Ramaswamy\textquotesingle{}s Top 8 Songs"}\NormalTok{)}

\NormalTok{vivek}\SpecialCharTok{$}\NormalTok{track.name[vivek}\SpecialCharTok{$}\NormalTok{valence }\SpecialCharTok{==} \FunctionTok{min}\NormalTok{(vivek}\SpecialCharTok{$}\NormalTok{valence)]}
\end{Highlighting}
\end{Shaded}
...
Sometimes maps use shading of polygons to display quantitative
information about a geographic unit or qualitative information about
what geographical units belong to different categories of a variable. We
provide an example of this here.

\begin{itemize}
\tightlist
\item
  We are going to add a variable to our mapping data that we want to
  visualize
\item
  We \texttt{fill} the plot using \texttt{geom\_polygon} and can
  (optionally) indicate specific colors
\end{itemize}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{usmap }\OtherTok{\textless{}{-}} \FunctionTok{map\_data}\NormalTok{(}\StringTok{"state"}\NormalTok{)}
\NormalTok{usmap}\SpecialCharTok{$}\NormalTok{nj }\OtherTok{\textless{}{-}} \FunctionTok{ifelse}\NormalTok{(usmap}\SpecialCharTok{$}\NormalTok{region }\SpecialCharTok{==} \StringTok{"new jersey"}\NormalTok{, }\StringTok{"Cannot turn left"}\NormalTok{, }
                   \StringTok{"Can turn left"}\NormalTok{)}
\NormalTok{usmap}\SpecialCharTok{$}\NormalTok{nj }\OtherTok{\textless{}{-}} \FunctionTok{as.factor}\NormalTok{(usmap}\SpecialCharTok{$}\NormalTok{nj)}

\FunctionTok{ggplot}\NormalTok{()}\SpecialCharTok{+}
  \DocumentationTok{\#\# Note the fill= nj}
  \FunctionTok{geom\_polygon}\NormalTok{(}\AttributeTok{data=}\NormalTok{usmap, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{long, }\AttributeTok{y=}\NormalTok{lat, }\AttributeTok{group=}\NormalTok{group, }\AttributeTok{fill=}\NormalTok{nj))}\SpecialCharTok{+}
  \DocumentationTok{\#\# we can indicate colors for each category of the nj variable}
  \FunctionTok{scale\_fill\_manual}\NormalTok{(}\AttributeTok{values =} \FunctionTok{c}\NormalTok{(}\StringTok{"gray"}\NormalTok{, }\StringTok{"red3"}\NormalTok{), }\AttributeTok{name=}\StringTok{"Left Turns"}\NormalTok{)}\SpecialCharTok{+}
  \FunctionTok{theme\_void}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"Geography of Left Turns"}\NormalTok{)}\SpecialCharTok{+}
...
{\centering \includegraphics{12-Maps_files/figure-pdf/unnamed-chunk-14-1.pdf}

}

\end{figure}

\hypertarget{application-2021-nj-election-results}{%
\section{Application: 2021 NJ Election
Results}\label{application-2021-nj-election-results}}

We sometimes get data from an outside source. We then need to figure out
how to connect it to the mapping data.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{njcounties }\OtherTok{\textless{}{-}} \FunctionTok{map\_data}\NormalTok{(}\StringTok{"county"}\NormalTok{, }\AttributeTok{region=}\StringTok{"New Jersey"}\NormalTok{)}

\DocumentationTok{\#\# 2021 county election results}
\NormalTok{murphyvote }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{county =} \FunctionTok{unique}\NormalTok{(njcounties}\SpecialCharTok{$}\NormalTok{subregion),}
           \AttributeTok{murphy =} \FunctionTok{c}\NormalTok{(}\FloatTok{43.92}\NormalTok{, }\FloatTok{52.52}\NormalTok{, }\FloatTok{53.28}\NormalTok{, }\FloatTok{61.69}\NormalTok{, }\FloatTok{36.69}\NormalTok{, }\FloatTok{43.64}\NormalTok{, }
                      \FloatTok{73.96}\NormalTok{, }\FloatTok{44.63}\NormalTok{, }\FloatTok{73.56}\NormalTok{, }\FloatTok{40.19}\NormalTok{, }\FloatTok{65.09}\NormalTok{,}
                      \FloatTok{55.74}\NormalTok{, }\FloatTok{40.31}\NormalTok{, }\FloatTok{44.06}\NormalTok{, }\FloatTok{31.79}\NormalTok{, }\FloatTok{51.47}\NormalTok{, }
                      \FloatTok{35.01}\NormalTok{, }\FloatTok{51.54}\NormalTok{, }\FloatTok{31.93}\NormalTok{, }\FloatTok{61.56}\NormalTok{, }\FloatTok{34.56}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\DocumentationTok{\#\# initialize variable}
\NormalTok{usmap}\SpecialCharTok{$}\NormalTok{photoidlaws }\OtherTok{\textless{}{-}} \ConstantTok{NA}

\NormalTok{usmap}\SpecialCharTok{$}\NormalTok{photoidlaws[usmap}\SpecialCharTok{$}\NormalTok{region }\SpecialCharTok{\%in\%} \FunctionTok{c}\NormalTok{(}\StringTok{"arkansas"}\NormalTok{,}\StringTok{"georgia"}\NormalTok{, }\StringTok{"indiana"}\NormalTok{, }\StringTok{"kansas"}\NormalTok{,}
                                      \StringTok{"mississippi"}\NormalTok{,}\StringTok{"missouri"}\NormalTok{, }\StringTok{"north carolina"}\NormalTok{, }\StringTok{"ohio"}\NormalTok{, }
                                      \StringTok{"tennessee"}\NormalTok{, }\StringTok{"wisconsin"}\NormalTok{)] }\OtherTok{\textless{}{-}} \StringTok{"Strict Photo ID"}

\NormalTok{usmap}\SpecialCharTok{$}\NormalTok{photoidlaws[usmap}\SpecialCharTok{$}\NormalTok{region }\SpecialCharTok{\%in\%} \FunctionTok{c}\NormalTok{(}\StringTok{"alabama"}\NormalTok{, }\StringTok{"florida"}\NormalTok{, }\StringTok{"idaho"}\NormalTok{, }\StringTok{"louisiana"}\NormalTok{, }
                                      \StringTok{"michigan"}\NormalTok{, }\StringTok{"montana"}\NormalTok{, }\StringTok{"rhode island"}\NormalTok{, }\StringTok{"south carolina"}\NormalTok{, }
                                      \StringTok{"south dakota"}\NormalTok{, }\StringTok{"texas"}\NormalTok{)] }\OtherTok{\textless{}{-}} \StringTok{"Non{-}Strict Photo ID"}

\NormalTok{usmap}\SpecialCharTok{$}\NormalTok{photoidlaws[usmap}\SpecialCharTok{$}\NormalTok{region }\SpecialCharTok{\%in\%} \FunctionTok{c}\NormalTok{(}\StringTok{"arizona"}\NormalTok{, }\StringTok{"north dakota"}\NormalTok{, }\StringTok{"wyoming"}\NormalTok{)]}\OtherTok{\textless{}{-}} \StringTok{"Strict Non{-}Photo ID"}

\NormalTok{usmap}\SpecialCharTok{$}\NormalTok{photoidlaws[usmap}\SpecialCharTok{$}\NormalTok{region }\SpecialCharTok{\%in\%} \FunctionTok{c}\NormalTok{(}\StringTok{"alaska"}\NormalTok{, }\StringTok{"colorado"}\NormalTok{, }\StringTok{"connecticut"}\NormalTok{, }\StringTok{"delaware"}\NormalTok{, }\StringTok{"hawaii"}\NormalTok{, }
                                      \StringTok{"iowa"}\NormalTok{, }\StringTok{"kentucky"}\NormalTok{, }\StringTok{"new hampshire"}\NormalTok{, }\StringTok{"oklahoma"}\NormalTok{, }\StringTok{"utah"}\NormalTok{, }
                                      \StringTok{"virginia"}\NormalTok{, }\StringTok{"washington"}\NormalTok{, }\StringTok{"west virginia"}\NormalTok{)] }\OtherTok{\textless{}{-}} \StringTok{"Non{-}Strict Non{-}Photo ID"}

\NormalTok{usmap}\SpecialCharTok{$}\NormalTok{photoidlaws[usmap}\SpecialCharTok{$}\NormalTok{region }\SpecialCharTok{\%in\%} \FunctionTok{c}\NormalTok{(}\StringTok{"oregon"}\NormalTok{, }\StringTok{"nevada"}\NormalTok{,}\StringTok{"california"}\NormalTok{, }\StringTok{"new mexico"}\NormalTok{, }
                                      \StringTok{"nebraska"}\NormalTok{, }\StringTok{"minnesota"}\NormalTok{, }\StringTok{"illinois"}\NormalTok{,  }\StringTok{"pennsylvania"}\NormalTok{, }
                                      \StringTok{"new york"}\NormalTok{, }\StringTok{"new jersey"}\NormalTok{, }\StringTok{"massachusetts"}\NormalTok{, }\StringTok{"vermont"}\NormalTok{,}
                                      \StringTok{"maryland"}\NormalTok{,  }\StringTok{"district of columbia"}\NormalTok{, }\StringTok{"maine"}\NormalTok{)] }\OtherTok{\textless{}{-}} \StringTok{"No Document Required"}


\DocumentationTok{\#\# Make it a factor categorical variable}
\NormalTok{usmap}\SpecialCharTok{$}\NormalTok{photoidlaws }\OtherTok{\textless{}{-}} \FunctionTok{as.factor}\NormalTok{(usmap}\SpecialCharTok{$}\NormalTok{photoidlaws)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{italyspain}\SpecialCharTok{$}\NormalTok{case\_count\_thousands }\OtherTok{\textless{}{-}}\NormalTok{ italyspain}\SpecialCharTok{$}\NormalTok{case\_count }\SpecialCharTok{/}\DecValTok{1000}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{images/syriamap.gif}
...
\begin{Shaded}
\begin{Highlighting}[]
\DocumentationTok{\#\# Option 1: create new variable}
\DocumentationTok{\#\# gender 2=Male, 1=Female}
\NormalTok{uglydata}\SpecialCharTok{$}\NormalTok{gender }\OtherTok{\textless{}{-}}\NormalTok{ uglydata}\SpecialCharTok{$}\NormalTok{VV160002}

\DocumentationTok{\#\# Option 2: Overwrite}
\FunctionTok{names}\NormalTok{(uglydata)[}\DecValTok{1}\NormalTok{] }\OtherTok{\textless{}{-}} \StringTok{"gender2"}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\DocumentationTok{\#\# Summarize this variable}
\FunctionTok{summary}\NormalTok{(uglydata}\SpecialCharTok{$}\NormalTok{gender)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\DocumentationTok{\#\# What is the length of the subset of the variable where the data are missing}
\FunctionTok{length}\NormalTok{(uglydata}\SpecialCharTok{$}\NormalTok{gender[}\FunctionTok{is.na}\NormalTok{(uglydata}\SpecialCharTok{$}\NormalTok{gender) }\SpecialCharTok{==}\NormalTok{ T])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{mean}\NormalTok{(uglydata}\SpecialCharTok{$}\NormalTok{VV1400068, }\AttributeTok{na.rm=}\NormalTok{T)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\DocumentationTok{\#\# create variable indicating over 65 vs. under 65}

\DocumentationTok{\#\# approach 1}
\NormalTok{uglydata}\SpecialCharTok{$}\NormalTok{over65 }\OtherTok{\textless{}{-}} \ConstantTok{NA}
\NormalTok{uglydata}\SpecialCharTok{$}\NormalTok{over65[uglydata}\SpecialCharTok{$}\NormalTok{VV1400068 }\SpecialCharTok{\textgreater{}=}\DecValTok{65}\NormalTok{] }\OtherTok{\textless{}{-}} \DecValTok{1}
\NormalTok{uglydata}\SpecialCharTok{$}\NormalTok{over65[uglydata}\SpecialCharTok{$}\NormalTok{VV1400068 }\SpecialCharTok{\textless{}} \DecValTok{65}\NormalTok{] }\OtherTok{\textless{}{-}} \DecValTok{0}


\DocumentationTok{\#\# approach 2}
\NormalTok{uglydata}\SpecialCharTok{$}\NormalTok{over65 }\OtherTok{\textless{}{-}} \FunctionTok{ifelse}\NormalTok{(uglydata}\SpecialCharTok{$}\NormalTok{VV1400068 }\SpecialCharTok{\textgreater{}=}\DecValTok{65}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{0}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{col }\OtherTok{\textless{}{-}} \ConstantTok{NA}
\NormalTok{col[senator}\SpecialCharTok{$}\NormalTok{party }\SpecialCharTok{==} \StringTok{"R"}\NormalTok{] }\OtherTok{\textless{}{-}} \FunctionTok{rgb}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{0}\NormalTok{,}\DecValTok{0}\NormalTok{, }\AttributeTok{alpha=}\NormalTok{.}\DecValTok{5}\NormalTok{)}
\NormalTok{col[senator}\SpecialCharTok{$}\NormalTok{party }\SpecialCharTok{==} \StringTok{"D"}\NormalTok{] }\OtherTok{\textless{}{-}} \FunctionTok{rgb}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{0}\NormalTok{,}\DecValTok{1}\NormalTok{, }\AttributeTok{alpha=}\NormalTok{.}\DecValTok{5}\NormalTok{)}
\NormalTok{col[senator}\SpecialCharTok{$}\NormalTok{party }\SpecialCharTok{==} \StringTok{"I"}\NormalTok{] }\OtherTok{\textless{}{-}} \StringTok{"black"}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics{13-ChooseYourOwnAdventure_files/figure-pdf/unnamed-chunk-17-1.pdf}
