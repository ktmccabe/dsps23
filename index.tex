...
\includegraphics[width=0.4\textwidth,height=\textheight]{images/greg1.png}
\includegraphics[width=0.4\textwidth,height=\textheight]{images/greg2.png}
...
\NormalTok{sotu.corpus }\OtherTok{\textless{}{-}} \FunctionTok{Corpus}\NormalTok{(}\FunctionTok{VectorSource}\NormalTok{(speeches}\SpecialCharTok{$}\NormalTok{sotu\_text))}
...
\begin{Shaded}
\begin{Highlighting}[]
\DocumentationTok{\#\# create variable as NA}
\NormalTok{usmap}\SpecialCharTok{$}\NormalTok{photoidlaws }\OtherTok{\textless{}{-}} \ConstantTok{NA}

\DocumentationTok{\#\# Fill in vaariable with state categories}
\NormalTok{usmap}\SpecialCharTok{$}\NormalTok{photoidlaws[usmap}\SpecialCharTok{$}\NormalTok{region }\SpecialCharTok{\%in\%} \FunctionTok{c}\NormalTok{(}\StringTok{"arkansas"}\NormalTok{,}\StringTok{"georgia"}\NormalTok{, }\StringTok{"indiana"}\NormalTok{, }\StringTok{"kansas"}\NormalTok{,}\StringTok{"mississippi"}\NormalTok{, }\StringTok{"tennessee"}\NormalTok{, }\StringTok{"wisconsin"}\NormalTok{)] }\OtherTok{\textless{}{-}} \StringTok{"Strict Photo ID"}
...
\NormalTok{usmap}\SpecialCharTok{$}\NormalTok{photoidlaws[usmap}\SpecialCharTok{$}\NormalTok{region }\SpecialCharTok{\%in\%} \FunctionTok{c}\NormalTok{(}\StringTok{"arizona"}\NormalTok{, }\StringTok{"north dakota"}\NormalTok{, }
                                      \StringTok{"ohio"}\NormalTok{, }\StringTok{"wyoming"}\NormalTok{)]}\OtherTok{\textless{}{-}} \StringTok{"Strict Non{-}Photo ID"}

\NormalTok{usmap}\SpecialCharTok{$}\NormalTok{photoidlaws[usmap}\SpecialCharTok{$}\NormalTok{region }\SpecialCharTok{\%in\%} \FunctionTok{c}\NormalTok{(}\StringTok{"alaska"}\NormalTok{, }\StringTok{"colorado"}\NormalTok{, }\StringTok{"connecticut"}\NormalTok{, }
                                      \StringTok{"delaware"}\NormalTok{, }\StringTok{"hawaii"}\NormalTok{, }\StringTok{"iowa"}\NormalTok{, }\StringTok{"kentucky"}\NormalTok{, }\StringTok{"missouri"}\NormalTok{, }
                                      \StringTok{"new hampshire"}\NormalTok{, }\StringTok{"oklahoma"}\NormalTok{, }\StringTok{"utah"}\NormalTok{, }\StringTok{"virginia"}\NormalTok{, }
                                      \StringTok{"washington"}\NormalTok{, }\StringTok{"west virginia"}\NormalTok{)] }\OtherTok{\textless{}{-}} \StringTok{"Non{-}Strict Non{-}Photo ID"}

\NormalTok{usmap}\SpecialCharTok{$}\NormalTok{photoidlaws[usmap}\SpecialCharTok{$}\NormalTok{region }\SpecialCharTok{\%in\%} \FunctionTok{c}\NormalTok{(}\StringTok{"oregon"}\NormalTok{, }\StringTok{"nevada"}\NormalTok{,}\StringTok{"california"}\NormalTok{, }
                                      \StringTok{"new mexico"}\NormalTok{, }\StringTok{"nebraska"}\NormalTok{, }\StringTok{"minnesota"}\NormalTok{, }
                                      \StringTok{"illinois"}\NormalTok{, }\StringTok{"north carolina"}\NormalTok{, }\StringTok{"pennsylvania"}\NormalTok{, }
                                      \StringTok{"new york"}\NormalTok{, }\StringTok{"new jersey"}\NormalTok{, }\StringTok{"massachusetts"}\NormalTok{,}
                                      \StringTok{"vermont"}\NormalTok{, }\StringTok{"maryland"}\NormalTok{, }\StringTok{"north carolina"}\NormalTok{, }
                                      \StringTok{"district of columbia"}\NormalTok{, }
                                      \StringTok{"maine"}\NormalTok{)] }\OtherTok{\textless{}{-}} \StringTok{"No Document Required"}
